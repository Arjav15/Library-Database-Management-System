...
-- Create a User for Library Staff (Admin)

CREATE USER 'librarian'@'localhost' IDENTIFIED BY 'lib@123';

--  Give Admin-Level Privileges

GRANT SELECT, INSERT, UPDATE, DELETE ON librarymanagement.* TO 'librarian'@'localhost';

-- Create a User for Regular Member (Reader)

CREATE USER 'memberuser'@'localhost' IDENTIFIED BY 'mem@123';

-- Give Least Privileges (Only Read Access)

GRANT SELECT ON librarymanagement.books TO 'memberuser'@'localhost';
GRANT SELECT ON librarymanagement.authors TO 'memberuser'@'localhost';

GRANT DELETE ON librarymanagement.books TO 'librarian'@'localhost';

-- Revoke Access if Needed

REVOKE DELETE ON librarymanagement.books FROM 'librarian'@'localhost';